...
let handler = async (m, { conn }) => {
  ...
  const owners = [
    {
      name: 'HERNANDEZ.𝗑𝗒𝗓',
      desc: `𝖢𝗋𝖾𝖺𝖽𝗈𝗋 𝗒 𝖣𝖾𝗌𝖺𝗋𝗋𝗈𝗅𝗅𝖺𝖽𝗈𝗋 𝖯𝗋𝗂𝗇𝖼𝗂𝗉𝖺𝗅 𝖣𝖾 VIP BOT 👑`,
    ...
    },
    {
      ...
      image: 'https://files.catbox.moe/dqftmk.jpg',
      buttons: [
    ...
    {
      name: 'DIDIER.𝗌𝗍𝖺𝖿𝖿',
      desc: '𝖬𝗂𝖾𝗆𝖻𝗋𝗈 𝖮𝖿𝗂𝖼𝗂𝖺𝗅 𝖣𝖾𝗅 𝖤𝗊𝗎𝗂𝗉𝗈 VIP BOT ⚙️',
      image: 'https://files.catbox.moe/piu53i.jpg',
      buttons: [
        { name: 'WhatsApp', url: 'https://wa.me/593969367904' }
      ]
    }
  ]
